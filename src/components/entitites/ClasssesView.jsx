...
function ClassesView(props) {
  //Initialization ---------------------------------------------------------
  const typeofpage = props.type;

  console.log("Type is " + typeofpage);
  ...
  const updatedClasses = classes.map((class1) => {
    let valid = true;

    // Check within enrolledClasses
    enrolledClasses.forEach((x) => {
    if (x.ClassID === class1.ClassID) {
        valid = false;
    }
    });

    class1.enrolled =valid;  
  }
  );
                    ...
                    (<h1 className="title">{class1.ClassTitle}</h1>
                      ...
                      <div className="text1">
                        ...
                        <>
                            ...
                            to={`/Attendee?classId=${class1.ClassID}`}
